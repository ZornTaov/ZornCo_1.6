package zornco.monstercompress.blocks;
...
public class BlockCompressor extends BlockContainer {
    ...
    public BlockCompressor(int par1)
    {
        ...
        this.setCreativeTab(MonsterCompressor.compressorTab);
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
        	TileCompressor tileentityhopper = getHopperTile(par1World, par2, par3, par4);
    ...
    public boolean onBlockActivated(World par1World, int i, int j, int k, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
        	TileCompressor te = (TileCompressor)par1World.getBlockTileEntity(i, j, k);;

            if (te != null) {
            	TileCompressor teus = (TileCompressor) te;
            	par5EntityPlayer.openGui(MonsterCompressor.instance, GuiIds.UPGRADE_STATION, par1World, i, j, k);
    ...
    {
    	TileCompressor tileentityhopper = (TileCompressor)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        return par0Str == "hopper" ? hopperIcon : (par0Str == "hopper_inside" ? hopperInsideIcon : null);
    }
    ...
    public static TileCompressor getHopperTile(IBlockAccess par0IBlockAccess, int par1, int par2, int par3)
    {
        return (TileCompressor)par0IBlockAccess.getBlockTileEntity(par1, par2, par3);
    }
