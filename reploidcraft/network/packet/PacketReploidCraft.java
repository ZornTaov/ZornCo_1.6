package zornco.reploidcraft.network.packet;
 ...
 * 
 */
public class PacketReploidCraft {

    public PacketTypeHandler packetType;
    public boolean isChunkDataPacket;

    public PacketReploidCraft(PacketTypeHandler packetType, boolean isChunkDataPacket) {
