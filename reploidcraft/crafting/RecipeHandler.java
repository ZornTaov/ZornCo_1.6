...
public class RecipeHandler {
	...
	public void registerRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(ReploidCraft.reploidHelm), 
				new Object[] { 
			"pep", "d d",  
			Character.valueOf('p'), new ItemStack(ReploidCraft.reploidPlate, 1, 4),
			Character.valueOf('e'), new ItemStack(ReploidCraft.reploidPlate, 1, 1),
			Character.valueOf('d'), new ItemStack(ReploidCraft.reploidPlate, 1, 12)
		}
				);
		...
		GameRegistry.addRecipe(new ItemStack(ReploidCraft.reploidChest), 
			...
			"p p", "pep", "ddd",  
			Character.valueOf('p'), new ItemStack(ReploidCraft.reploidPlate, 1, 4),
			Character.valueOf('e'), new ItemStack(ReploidCraft.component, 1, 1),
			Character.valueOf('d'), new ItemStack(ReploidCraft.reploidPlate, 1, 12)
		}
				);
		...
		GameRegistry.addRecipe(new ItemStack(ReploidCraft.buster), 
			...
			Character.valueOf('d'), new ItemStack(ReploidCraft.reploidPlate, 1, 8)
		}
				);
