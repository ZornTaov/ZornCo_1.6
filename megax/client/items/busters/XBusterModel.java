...
public class XBusterModel extends ModelBase {
	...
	public XBusterModel()
	{
		...
		Left.setRotationPoint(1F, 24F, 0F);
		...
		NozzleRight.setRotationPoint(0F, 24F, 0F);
		...
		NozzleTop.setRotationPoint(0F, 24F, 0F);
		NozzleTop.setTextureSize(64, 32);
		//NozzleTop.mirror = true;
		setRotation(NozzleTop, 0F, 1.570796F, 1.570796F);
		Inner = new ModelRenderer(this, 18, 15);
		Inner.addBox(-2F, -1F, 3.5F, 3, 2, 0);
		Inner.setRotationPoint(1F, 24F, 0F);
		Inner.setTextureSize(64, 32);
		//Inner.mirror = true;
		setRotation(Inner, 1.570796F, 0F, 0F);
		InnerFront = new ModelRenderer(this, 16, 14);
		InnerFront.addBox(1F, -1F, 3F, 0, 2, 1);
		InnerFront.setRotationPoint(1F, 24F, 0F);
