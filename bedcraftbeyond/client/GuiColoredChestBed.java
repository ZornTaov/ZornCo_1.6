...
public class GuiColoredChestBed extends GuiContainer {
    ...
    {
        this.fontRenderer.drawString(this.chestInventory.isInvNameLocalized() ? this.chestInventory.getInvName() : I18n.func_135053_a(this.chestInventory.getInvName()), 8, 6+ 17 , 4210752);                  
        this.fontRenderer.drawString(this.playerInventory.isInvNameLocalized() ? this.playerInventory.getInvName() : I18n.func_135053_a(this.playerInventory.getInvName()), 8, this.ySize - 96 + 2 + 17 , 4210752);
    }
	@Override
